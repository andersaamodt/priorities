...
grep -q 'data-support-dev-action="deleteIncompleteTask"' index.html
...
grep -q "triggerSupportDevZap('deleteIncompleteTask'" index.html
grep -q 'wasIncomplete = readCachedCheckedValue(path) !== 1' index.html
